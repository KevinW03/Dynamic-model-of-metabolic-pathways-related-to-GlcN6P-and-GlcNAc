...
function BNZR206_proGlcNAc_lowcopy
% Strain BNZR2.06 with the lowcopy synthetic pathway of GlcNAc
...
for i = 1:m
    ...
    par.ki =rand(1);
    par.vmax(1) = 0.5;
    par.vmax(5) = 0.4*(1-0.735); % HMP 
    par.vmax(6) = 1.9*(1-0.555); % EMP
    par.vmax(7) = 0.5*(1-0.261); % PSP 
    par.vmax(11) = 0.5; % The synthetic pathway of GlcNAc 
