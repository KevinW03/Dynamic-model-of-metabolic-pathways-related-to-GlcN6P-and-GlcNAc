...
function BNZR200_pfkAR
% Strain BNZR2.00 after weakening pfkA
...
for i = 1:m
    ...
    pfkA_RL = 0.95*rand(1); % Downregulating pfkA
...
writematrix( [repressing_pfkA GlcN6P_yield GlcNAc_yield],'yield.xlsx');
