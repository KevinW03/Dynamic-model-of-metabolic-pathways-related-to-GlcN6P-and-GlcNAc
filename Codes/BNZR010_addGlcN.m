...
function BNZR010_addGlcN
% Strain BNZR0.10 supplied with GlcN
...
for i = 1:m
    ...
    par.vmax(8) = 1; % The catabolic pathway of GlcNAc
    par.vmax(9) = 0.6; % The catabolic pathway of GlcN6P
    
    % initial metabolite concentrations
    x0 = zeros(1,x);
    x0(1,1)=1;
    x0(1,8)=2; % Suppling GlcN
...
% Reaction v_4
vmax(4)= par.vmax(4)*(par.ki^par.n/(par.ki^par.n+x(4)^par.n));
